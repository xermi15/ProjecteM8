            ...
            <tbody>
                ...
                @foreach($plantilla as $plantillas)
                    <tr>
                        ...
                        <td><a href="{{url('/CU_27_EditarPlantilla/'.$plantillas->idPlantilla)}}" class="btn btn-warning btn-lg active" role="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
